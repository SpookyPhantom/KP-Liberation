...
militia_squad = [
	"rhs_vdv_des_sergeant",												//Team Leader
	"rhs_vdv_des_efreitor",												//Squad Leader
	"rhs_vdv_des_rifleman",												//Rifleman
	"rhs_vdv_des_rifleman",												//Rifleman
	"rhs_vdv_des_rifleman",												//Rifleman
	"rhs_vdv_des_grenadier_rpg",										//Rifleman (AT)
	"rhs_vdv_des_grenadier",											//Grenadier
	"rhs_vdv_des_arifleman",											//Autorifleman
	"rhs_vdv_des_machinegunner",										//Machine Gunner
	"rhs_vdv_des_marksman",												//Marksman
	"rhs_vdv_des_medic",												//Medic
	"rhs_vdv_des_engineer"												//Engineer
];
...
opfor_battlegroup_vehicles_low_intensity = [
	"rhs_tigr_m_3camo_vdv",												//GAZ-233011
	"rhs_tigr_sts_3camo_vdv",											//GAZ-233014 (Armed)
	"rhs_tigr_sts_3camo_vdv",											//GAZ-233014 (Armed)
	"RHS_Ural_Open_vdv_01",												//Ural-4320 Transport
	"rhs_btr80_vdv",													//BTR-80
