...
opfor_officer = "rhs_vdv_mflora_officer_armored";							//Officer
opfor_team_leader = "rhs_vdv_mflora_sergeant";								//Team Leader
opfor_squad_leader = "rhs_vdv_mflora_efreitor";							//Squad Leader
opfor_sentry = "rhs_vdv_mflora_rifleman";									//Rifleman (Lite)
opfor_rifleman = "rhs_vdv_mflora_rifleman";								//Rifleman
opfor_rpg = "rhs_vdv_mflora_grenadier_rpg";								//Rifleman (LAT)
opfor_grenadier = "rhs_vdv_mflora_grenadier";								//Grenadier
opfor_machinegunner = "rhs_vdv_mflora_arifleman";							//Autorifleman
opfor_heavygunner = "rhs_vdv_mflora_machinegunner";						//Heavy Gunner
opfor_marksman = "rhs_vdv_mflora_marksman";								//Marksman
opfor_sharpshooter = "rhs_vdv_mflora_marksman";							//Sharpshooter
opfor_sniper = "rhs_vdv_mflora_marksman";									//Sniper
opfor_at = "rhs_vdv_mflora_at";											//AT Specialist
opfor_aa = "rhs_vdv_mflora_aa";											//AA Specialist
opfor_medic = "rhs_vdv_mflora_medic";										//Combat Life Saver
opfor_engineer = "rhs_vdv_mflora_engineer";								//Engineer
opfor_paratrooper = "rhs_vdv_mflora_rifleman_lite";						//Paratrooper
...
militia_squad = [
	"rhs_vdv_mflora_sergeant",												//Team Leader
	"rhs_vdv_mflora_efreitor",												//Squad Leader
	"rhs_vdv_mflora_rifleman",												//Rifleman
	"rhs_vdv_mflora_rifleman",												//Rifleman
	"rhs_vdv_mflora_rifleman",												//Rifleman
	"rhs_vdv_mflora_grenadier_rpg",										//Rifleman (AT)
	"rhs_vdv_mflora_grenadier",											//Grenadier
	"rhs_vdv_mflora_arifleman",											//Autorifleman
	"rhs_vdv_mflora_machinegunner",										//Machine Gunner
	"rhs_vdv_mflora_marksman",												//Marksman
	"rhs_vdv_mflora_medic",												//Medic
	"rhs_vdv_mflora_engineer"												//Engineer
];
