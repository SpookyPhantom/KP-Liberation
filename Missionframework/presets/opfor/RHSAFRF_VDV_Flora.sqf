...
opfor_officer = "rhs_vdv_flora_officer_armored";							//Officer
opfor_team_leader = "rhs_vdv_flora_sergeant";								//Team Leader
opfor_squad_leader = "rhs_vdv_flora_efreitor";							//Squad Leader
opfor_sentry = "rhs_vdv_flora_rifleman";									//Rifleman (Lite)
opfor_rifleman = "rhs_vdv_flora_rifleman";								//Rifleman
opfor_rpg = "rhs_vdv_flora_grenadier_rpg";								//Rifleman (LAT)
opfor_grenadier = "rhs_vdv_flora_grenadier";								//Grenadier
opfor_machinegunner = "rhs_vdv_flora_arifleman";							//Autorifleman
opfor_heavygunner = "rhs_vdv_flora_machinegunner";						//Heavy Gunner
opfor_marksman = "rhs_vdv_flora_marksman";								//Marksman
opfor_sharpshooter = "rhs_vdv_flora_marksman";							//Sharpshooter
...
opfor_paratrooper = "rhs_vdv_flora_rifleman_lite";						//Paratrooper
...
militia_squad = [
	"rhs_vdv_flora_sergeant",												//Team Leader
	"rhs_vdv_flora_efreitor",												//Squad Leader
	"rhs_vdv_flora_rifleman",												//Rifleman
	"rhs_vdv_flora_rifleman",												//Rifleman
	"rhs_vdv_flora_rifleman",												//Rifleman
	"rhs_vdv_flora_grenadier_rpg",										//Rifleman (AT)
	"rhs_vdv_flora_grenadier",											//Grenadier
	"rhs_vdv_flora_arifleman",											//Autorifleman
	"rhs_vdv_flora_machinegunner",										//Machine Gunner
