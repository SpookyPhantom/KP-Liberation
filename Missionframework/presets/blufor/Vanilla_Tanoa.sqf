...
KP_liberation_boat_classname = "B_T_Boat_Transport_01_F"; 				// These are the boats which spawn at the stern of the Freedom.																			Default is "B_Boat_Transport_01_F".
...
infantry_units = [
	...
	["B_T_soldier_mine_F",30,0,0],										//Mine Specialist
