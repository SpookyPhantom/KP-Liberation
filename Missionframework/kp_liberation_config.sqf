...
30 = LDF (Contact DLC)
31 = SOGPF
32 = RHS GREF Chernarus Defense Force */
...
KP_liberation_fuel_neutral = 6000;
...
GRLIB_save_key = "KP_LIBERATION_" + (toUpper worldName) + "_" + (str KP_liberation_preset_blufor) + "_SAVEGAME";
